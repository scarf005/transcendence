...
export class UserController {
  ...
  @ApiCreatedResponse({ description: '중복이면 true, 아니면 false', type: Boolean })
  ...
  @ApiOperation({ summary: 'Get My User data API', description: 'auth token 에서 uid 추출' })
  ...
  @Get('/:uid')
  @UseGuards(JwtAfterTwoFactorUserGuard)
  @ApiOperation({ summary: 'Get User data API', description: 'qurry string: uid' })
  @ApiCreatedResponse({ description: 'FindUserDto', type: FindUserDto })
  ...
  @ApiCreatedResponse({ description: 'FindUserDto[]', type: Array<FindUserDto> })
  ...
  @Post('/friend')
  @UseGuards(JwtAfterTwoFactorUserGuard)
  @ApiOperation({ summary: 'Post friend API', description: 'body의 friendUid:uid 추가할 uid' })
  @ApiCreatedResponse({ description: 'ok : 추가됐다, no : exception', type: String })
  ...
  @Post('/block')
  @UseGuards(JwtAfterTwoFactorUserGuard)
  @ApiOperation({ summary: 'Post block API', description: 'body의 blockUid:uid 추가할 uid' })
  @ApiCreatedResponse({ description: 'ok : 추가됐다, no : exception', type: String })
  ...
  @Delete('/friend')
  @UseGuards(JwtAfterTwoFactorUserGuard)
  @ApiOperation({ summary: 'Delete friend API', description: 'body의 friendUid:uid 제거할 uid' })
  @ApiCreatedResponse({ description: 'ok : 제거됐다, no : exception', type: String })
  ...
  @Delete('/block')
  @UseGuards(JwtAfterTwoFactorUserGuard)
  @ApiOperation({ summary: 'delete block API', description: 'body의 blockUid:uid 제거할 uid'  })
  @ApiCreatedResponse({ description: 'ok : 추가됐다, no : exception', type: String })
